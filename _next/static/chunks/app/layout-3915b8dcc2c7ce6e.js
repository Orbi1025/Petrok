(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    1497: function (e, t, r) {
      Promise.resolve().then(r.t.bind(r, 4671, 23)),
        Promise.resolve().then(r.bind(r, 7776)),
        Promise.resolve().then(r.t.bind(r, 3054, 23)),
        Promise.resolve().then(r.bind(r, 2732)),
        Promise.resolve().then(r.bind(r, 2811)),
        Promise.resolve().then(r.bind(r, 237));
    },
    4088: function (e, t, r) {
      "use strict";
      r.d(t, {
      ...
      function h() {
        ...
        return (0, s.jsxs)("div", {
          children: [
            (0, s.jsx)("button", {
              className:
                "fixed top-6 right-6 *:transition-all *:ease-in-out duration-200 hover:scale-105 active:scale-100  border-black border-4 rounded-lg bg-black/50  z-50 p-2",
              onClick: () => t(!e),
            ...
            (0, s.jsx)("button", {
              className:
                "fixed top-6 right-28 *:transition-all *:ease-in-out duration-200 hover:scale-105 active:scale-100  border-black border-4 rounded-lg bg-black/50  z-50 p-2",
              onClick: () => {
                x.current && (h ? x.current.pause() : x.current.play(), C(!h));
              },
              children: (0, s.jsx)(l.default, {
                src: h ? "https://www.petrok.world/icons/volume.svg" : "/icons/muted.svg",
                className: "w-12 h-12",
                width: 50,
                height: 50,
                alt: "",
            ...
            (0, s.jsx)("audio", { ref: x, src: "/audio/petrok.mp3", loop: !0 }),
            (0, s.jsx)(n.M, {
              children:
                e &&
                (0, s.jsx)(a.E.div, {
            ...
            (0, s.jsxs)(a.E.div, {
              className:
                "fixed font-[Starlight] justify-between gap-20 flex flex-col  border-black text-black border-8 bottom-4  md:bottom-12 right-4 md:right-20 w-[90%] md:w-[440px] h-fit   bg-[#d0d0d0] shadow-lg rounded-none p-4 md:p-8 z-50",
              ...
              children: [
                (0, s.jsx)(l.default, {
                  className:
                    "absolute -top-10 transform w-60 h-auto -translate-x-1/2 left-1/2",
                  src: "/brand/petrok.png",
                  width: 240,
                  priority: !0,
                  height: 1e3,
                  alt: "",
                ...
                (0, s.jsxs)("ul", {
                  className:
                    " *:transition-all *:ease-in-out  mt-4 text-black/50 text-4xl",
                  children: [
                    (0, s.jsxs)("li", {
                      className:
                        "py-2 cursor-pointer flex items-center gap-4  hover:pl-2 overflow-clip  hover:text-black",
                      onClick: () => f("/"),
                      children: [
                        (0, s.jsx)(l.default, {
                          className: " w-10 h-10",
                ...
                (0, s.jsxs)("div", {
                  className:
                    "flex flex-col gap-4 md:gap-2 md:flex-row  items-end  justify-between",
                  children: [
                    (0, s.jsxs)("div", {
                      className: " flex *:transition-all *:ease-in-out gap-2",
                      children: [
                        (0, s.jsx)(c.default, {
                          className:
                            "bg-black p-3 hover:scale-105 active:scale-100 ",
                          target: "_blank",
                          href: u.t.urls.x,
                          children: (0, s.jsx)(l.default, {
                            className: "w-8 h-8",
    ...
    572: function (e, t, r) {
      ...
      let s = {
        urls: {
          ...
          dextools:
            "https://www.dextools.io/app/en/base/pool-explorer/0x461ded3B409EFEf768837Ca4f1A27615901B69c9",
          Uniswap:
            "https://app.uniswap.org/#/swap?inputCurrency=base&outputCurrency=0x461ded3B409EFEf768837Ca4f1A27615901B69c9",
        },
    ...
    2811: function (e, t, r) {
      ...
      let n = (0, o.createContext)(void 0),
        a = (e) => {
          ...
          return (0, s.jsx)(n.Provider, { value: c, children: t });
        },
        l = () => {
    ...
    237: function (e, t, r) {
      ...
      var s = r(7437),
        ...
        a = r(4088);
      function l() {
        let { isLoading: e, isExiting: t } = (0, n.r)();
        return (0, s.jsx)(o.E.div, {
          children: (0, s.jsx)(o.E.div, {
            initial: { y: "0%", rotate: -5 },
            animate: { y: e || t ? "0%" : "-150%", rotate: -5 },
            exit: { y: t ? "150%" : "0%", rotate: -5 },
            transition: { ease: [0.77, 0, 0.175, 1], duration: 1.3 },
            className:
              "fixed top-0 left-0 w-full h-full z-[100] flex items-center justify-center",
            children: (0, s.jsxs)("div", {
              className:
                "absolute top-0 left-0 w-[150vw] pb-4 h-[150vh]  border-b-8 border-black",
              style: { transform: "translate(-25vw, -25vh)" },
              children: [
                (0, s.jsx)("div", {
                  className:
                    " absolute top-0 left-0 flex items-center justify-center w-full h-full z-50",
                  children: (0, s.jsx)(a.S9, {
                    className: "  stroke-[#232323] w-36 h-36 ",
                  }),
                }),
                (0, s.jsxs)("div", {
                  className:
                    "absolute top-0 left-0 w-full bg-gradient-to-tr to-[#687789] from-[#5a6987] h-full flex flex-col justify-between",
                  children: [
                    [...Array(24)].map((e, t) =>
                      (0, s.jsx)(
                        "div",
                    ...
                    (0, s.jsx)("div", {
                      className:
                        "w-full h-24 border-t-8 border-black bg-[#A9AEB5]",
                    }),
                  ],
                }),
              ],
    ...
    1980: function (e, t, r) {
      ...
      function n() {
        let e = (0, s.useRouter)(),
          { setIsLoading: t, setIsExiting: r } = (0, o.r)();
        return {
          navigate: async (s) => {
            r(!0),
              setTimeout(async () => {
  ...
  function (e) {
    e.O(0, [93, 648, 592, 578, 971, 23, 744], function () {
      return e((e.s = 1497));
    }),
      (_N_E = e.O());
  },
